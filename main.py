...
def analyze_sentiment_bert(text, tokenizer, model, model_name): 
...
def analyze_sentiment(text, models):
    ...
    indobert_pred = analyze_sentiment_bert(preprocessed_text, models['indobert'][0], models['indobert'][1], "indobert")
    indoroberta_pred = analyze_sentiment_bert(preprocessed_text, models['indoroberta'][0], models['indoroberta'][1], "indoroberta")
...
def main(): 
    ...
    st.markdown("<h3 style='text-align: center;'>Menggunakan Model IndoBERT dan IndoRoBERTa</h3>", unsafe_allow_html=True)
    ...
    st.markdown("""
        <div class='footer'>
            <p>\u00a9 2024 Analisis Sentimen Teks Berita - Powered by IndoBERT and IndoRoBERTa | @nsyw.rhdtl</p>
        </div>
    """, unsafe_allow_html=True)
